...
def plot_regressed_3d_bbox(img, cam_to_img, box_2d, dimensions, alpha, theta_ray,poly, img_2d=None):
    ...
    plot_3d_box(img, cam_to_img, orient, dimensions, location,poly) # 3d boxes

    return location

def main(img_file: str,border_file:str):
    ...
    # for img_id in ids:
    if True:
        # # img_id='photo_2021-12-02_12-07-30'
        # # img_id='26-11-2021_02-42-07_AM'
        # img_id='photo_2021-12-02_20-01-41'
        ...
        poly=poly_by_border(border_file)
        ...
        for detection in detections:
            ...
            if FLAGS.show_yolo:
                location = plot_regressed_3d_bbox(img, proj_matrix, box_2d, dim, alpha, theta_ray,poly ,truth_img)
            else:
                location = plot_regressed_3d_bbox(img, proj_matrix, box_2d, dim, alpha, theta_ray,poly)
        ...
        if FLAGS.show_yolo:
            ...
            cv2.imwrite('source/prepared/3Dbox.jpg', img)
