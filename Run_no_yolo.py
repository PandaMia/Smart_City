...
def plot_regressed_3d_bbox(img, truth_img, cam_to_img, box_2d, dimensions, alpha, theta_ray,crossing=False):
    ...
    plot_3d_box(img, cam_to_img, orient, dimensions, location,crossing) # 3d boxes
...
def main():
    ...
    bord_poly=poly_by_border(border_file)
    ...
    for key in sorted(all_images.keys()):
        ...
        for detectedObject in objects:
            ...
            location = plot_regressed_3d_bbox(img, truth_img, cam_to_img, label['Box_2D'], dim, alpha, theta_ray,crossing=True)
